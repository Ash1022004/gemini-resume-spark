...
const Header = () => {
  return (
    <header className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-16 lg:py-24 min-h-screen">
      ...
      <div className="container relative z-10 mx-auto px-4 h-full">
        <div className="relative h-full">
          {/* Left Content - Random positioning */}
          <div className="absolute top-1/2 left-4 lg:left-8 transform -translate-y-1/2 space-y-8 max-w-2xl z-20">
            ...
            <p className="text-lg lg:text-xl text-gray-600 leading-relaxed max-w-lg animate-fade-in animation-delay-200">
          ...
          {/* Right Content - Rotating Resume with random positioning */}
          <div className="absolute top-1/4 right-8 lg:right-16 transform -translate-y-1/4 animate-fade-in animation-delay-1000">
            <RotatingResumePreview />
          </div>

          {/* Floating decoration elements */}
          <div className="absolute top-20 right-1/3 w-20 h-20 bg-blue-200/30 rounded-full animate-pulse hidden lg:block"></div>
          <div className="absolute bottom-32 left-1/4 w-16 h-16 bg-purple-200/30 rounded-full animate-pulse animation-delay-500 hidden lg:block"></div>
          <div className="absolute top-1/3 right-20 w-12 h-12 bg-green-200/30 rounded-full animate-pulse animation-delay-1000 hidden lg:block"></div>
        </div>
      </div>
    </header>
  );
